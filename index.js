...
const port = 3000;
const data = {
  header: "Welcome to the Band Generator 🤘",
  year: 0,
};
...
app.post("/submit", (req, res) => {
  ...
  let rand1 = Math.floor(Math.random() * adj.length);
  let rand2 = Math.floor(Math.random() * noun.length);
  let fBandName = adj[rand1].charAt(0).toUpperCase() + adj[rand1].slice(1);
  let sBandName = noun[rand2].charAt(0).toUpperCase() + noun[rand2].slice(1);

  data.header = fBandName + " " + sBandName;
  res.render("index.ejs", data);
});
